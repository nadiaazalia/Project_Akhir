...
Package  : entities
Module   : ghost
Desc     : Ghost hierarchy.
           Demonstrates: multi-level inheritance, method overriding,
                         polymorphism, abstract methods.

FIXES:
  - choose_move() sekarang @abstractmethod yang benar (bukan sekedar raise NotImplementedError)
  - Ghost.update() diperbaiki: normal ghost bergerak setiap 2 tick (bukan % 1 yang selalu True)
  - Spawn position ghost dicek agar tidak di dalam dinding (disesuaikan di game_engine.py)
"""
